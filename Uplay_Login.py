...
fileName = input("Readable Text Name")
...
browser = webdriver.Firefox(firefox_profile = fp)# browser = webdriver.Firefox()
...
if (browser.current_url == "https://support.ubi.com/en-US/SignIn/LoginSuccess"
  or browser.current_url == "https://connect.ubi.com/Default/EmailValidation?appId=19ba479c-b658-4b7e-8ffd-88f2c85b79e6&genomeId=f925bee3-bb86-4ef6-8293-e03e1d608a43&lang=en-US&nextUrl=https%3A%2F%2Fsupport.ubi.com%2Fen-US%2FSignIn%2FLoginSuccess"):
